...
const PartyWear = () => {
  ...
  const colors = ['Green', 'Black', 'Gold', 'Red', 'Blue', 'Purple'];
  ...
  const filteredProducts = products.filter(product => {
    ...
    if (priceRange !== 'all') {
      ...
      switch (priceRange) {
        case 'under-8000': return price < 8000;
        case '8000-12000': return price >= 8000 && price <= 12000;
        case '12000-16000': return price >= 12000 && price <= 16000;
        case 'above-16000': return price > 16000;
      }
    }
      ...
      <div className="max-w-7xl mx-auto py-8 px-4">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">
            Stunning party wear for your special occasions
          </p>
        </div>
              ...
              <div className="mb-6">
                ...
                <Select value={priceRange} onValueChange={setPriceRange}>
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="12000-16000">₹12,000 - ₹16,000</SelectItem>
                    <SelectItem value="above-16000">Above ₹16,000</SelectItem>
                  </SelectContent>
                </Select>
              </div>
